 ...
 */
#define USB_CFG_VENDOR_NAME     'A', 'n', 'g', 'e', 'l', 'i', 'n', 'u', 'x'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'B', 'l', 'u', 'e', 'v', 'e', 'r', 'y'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     0x00   /* define class here if not at device level */
